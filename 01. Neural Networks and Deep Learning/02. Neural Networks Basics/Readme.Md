...
* The gradient decent algorithm repeats: `w = w - alpha * dw`, where `alpha` is the learning rate (i.e., how big of a step in horizontal plane) and `dw` is the derivative of `w` (Change to w OR slope of 'w').
