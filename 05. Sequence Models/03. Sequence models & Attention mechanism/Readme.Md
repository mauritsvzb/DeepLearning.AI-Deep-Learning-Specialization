...
* A network using an attention mechanism can translate from inputs of length T<sup>x</sup> to outputs of length T<sup>y</sup>, where T<sup>x</sup> and T<sup>y</sup> can be different
